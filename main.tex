...
\begin{frame}{Base reducida}
El problema consiste en encontrar una base reducida $[a,b]$ del reticulado generado por dos vectores linealmente independientes $\textbf{a},\textbf{b} \in \mathbb{Z}^2$, tal que $||\textbf{a}'|| = \lambda_1$ y $||\textbf{b}'||= \lambda_2$, donde $\lambda_1$ y $\lambda_2$ son \textbf{mínimos sucesivos} del reticulado. 
    \begin{definition}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.30\linewidth]{figures/baseReducida.png}
